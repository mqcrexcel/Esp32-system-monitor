...
void DisplayStyle3 () {
  ...
  display.fillRect(38, 37, 90, 27, BLACK);  // fill GPU Freq live stats section only
  display.fillRect(0,  54, 35, 10, BLACK);  // fill GPU Temp live stats section only

  /* Position Test*/
  //display.drawRect(38, 11, 90, 18, WHITE); // fill CPU live stats section only
  //display.drawRect(38, 37, 90, 27, WHITE); // fill GPU Freq live stats section only
